  ...
  return (
    <>
      <div  id='Monetize' style={{textAlign:'center'}} className="section section-tabs">
        <Container>
              <h4 className="category">{language=='Eng'?"Make money with your internet":"Byaza umusaruro murandasi.duhuza nabakiriya tukwishyure"}</h4>
              <h5 className="category">{language=='Eng'?"How does it work , follow the video":"Bikorwa bite , Kurikira videwo ikurikira"}</h5>
              <center>
